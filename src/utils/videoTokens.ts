...
const GEMINI_CONTEXT_WINDOW = 1_048_576; // 1M tokens (Gemini 2.x and 3.x)
...
export function getContextWindowForModel(model: string = ''): number {
  ...
  // Gemini 2.x and 3.x series: 1M context window (1,048,576 tokens)
  if (/gemini[- ][23]\./.test(normalizedModel)) {
