...
export class ConfigService {
  ...
  private loadConfig(): Config {
    try {
      ...
      const rawConfig: Record<string, unknown> = {
        ...
        MEDIA_RESOLUTION: process.env.MEDIA_RESOLUTION,
        MEDIA_RESOLUTION_FOR_IMAGE: process.env.MEDIA_RESOLUTION_FOR_IMAGE,
        MEDIA_RESOLUTION_FOR_VIDEO: process.env.MEDIA_RESOLUTION_FOR_VIDEO,
        ...
        MAX_TOKENS_FOR_DETECT_OBJECTS_IN_IMAGE: process.env
          ...
          : undefined,
        TEMPERATURE_FOR_SEGMENT_OBJECTS_IN_IMAGE: process.env
          .TEMPERATURE_FOR_SEGMENT_OBJECTS_IN_IMAGE
          ? parseFloat(process.env.TEMPERATURE_FOR_SEGMENT_OBJECTS_IN_IMAGE)
          : 0, // Default to 0 for deterministic segmentation
        TOP_P_FOR_SEGMENT_OBJECTS_IN_IMAGE: process.env
          .TOP_P_FOR_SEGMENT_OBJECTS_IN_IMAGE
          ? parseFloat(process.env.TOP_P_FOR_SEGMENT_OBJECTS_IN_IMAGE)
          : undefined,
        TOP_K_FOR_SEGMENT_OBJECTS_IN_IMAGE: process.env
          .TOP_K_FOR_SEGMENT_OBJECTS_IN_IMAGE
          ? parseInt(process.env.TOP_K_FOR_SEGMENT_OBJECTS_IN_IMAGE, 10)
          : undefined,
        MAX_TOKENS_FOR_SEGMENT_OBJECTS_IN_IMAGE: process.env
          .MAX_TOKENS_FOR_SEGMENT_OBJECTS_IN_IMAGE
          ? parseInt(process.env.MAX_TOKENS_FOR_SEGMENT_OBJECTS_IN_IMAGE, 10)
          : undefined,
  ...
  public getMediaResolutionForTask(
    taskType: 'image' | 'video'
  ): string | undefined {
    const taskSpecific =
      taskType === 'image'
        ? this.config.MEDIA_RESOLUTION_FOR_IMAGE
        : this.config.MEDIA_RESOLUTION_FOR_VIDEO;
    return taskSpecific ?? this.config.MEDIA_RESOLUTION;
  }

  public getThinkingLevelForTask(
    taskType: 'image' | 'video'
  ): string | undefined {
    const taskSpecific =
      taskType === 'image'
  ...
  public getTemperatureForFunction(
    ...
    switch (functionName) {
      ...
      case FUNCTION_NAMES.SEGMENT_OBJECTS_IN_IMAGE:
