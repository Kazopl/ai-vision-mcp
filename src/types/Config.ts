...
export interface Config {
  ...
  // Media resolution (Gemini 3+): 'low' | 'medium' | 'high'
  MEDIA_RESOLUTION?: string;
  MEDIA_RESOLUTION_FOR_IMAGE?: string;
  MEDIA_RESOLUTION_FOR_VIDEO?: string;
  ...
  TEMPERATURE_FOR_SEGMENT_OBJECTS_IN_IMAGE?: number;
  TOP_P_FOR_SEGMENT_OBJECTS_IN_IMAGE?: number;
  TOP_K_FOR_SEGMENT_OBJECTS_IN_IMAGE?: number;
  MAX_TOKENS_FOR_SEGMENT_OBJECTS_IN_IMAGE?: number;
