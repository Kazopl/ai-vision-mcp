...
/**
 * Build a fetch mock (legacy module-shaped helper).
 * Prefer setupFetchMock / vi.stubGlobal('fetch', ...) since the source now
 * uses the native global fetch.
 */
